...
class AdminUserUpdate(BaseModel):
    email:EmailStr|None=None; username:str|None=Field(default=None, min_length=3, pattern=r"^[a-zA-Z0-9_.-]+$"); status:UserStatus|None=None; departments:list[str]|None=None; password:str|None=Field(default=None, min_length=8); is_admin:bool|None=None
